...
public class PostFXSettings : ScriptableObject
{
    ...
    {
        [Range(-100f, 100f)]
        public float temperature, tint;             // temperature: make the image cooler or warmer
                                                    // tint: tweak the temperature-shifted color
    }
    ...
    {
        [ColorUsage(false)]
        public Color shadows, highlights;           // shadows: tint shadow   hightlights: tint hightlights
